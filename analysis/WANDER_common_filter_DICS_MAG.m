function [common_filter, leadfield] = WANDER_common_filter_DICS_MAG(isubject,rootpath,force)

if rootpath == 1
    fname_source = ['w:\WANDER\data\beamformer\common_filter_s' num2str(isubject) '_DICS_MAG.mat'];
else
    fname_source = ['/shared/projects/project_wander/WANDER/data/beamformer/common_filter_s' num2str(isubject) '_DICS_MAG.mat'];
end
