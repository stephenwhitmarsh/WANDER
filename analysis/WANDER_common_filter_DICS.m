function [common_filter, leadfield] = WANDER_common_filter_DICS(isubject,rootpath,force)

if rootpath == 1
    fname_source = ['w:\WANDER\data\beamformer\common_filter_s' num2str(isubject) '_DICS.mat'];
else
    fname_source = ['/shared/projects/project_wander/WANDER/data/beamformer/common_filter_s' num2str(isubject) '_DICS.mat'];
end
