...
if restingstate == 1
    if rootpath == 1
        fname_ICA  = ['z:\WANDER\data\ICA\s' num2str(isubject) '_epoched_MEG_ICA_rs.mat'];
    else
        fname_ICA  = ['/shared/projects/project_wander/WANDER/data/ICA/s' num2str(isubject) '_epoched_MEG_ICA_rs.mat'];
    end
else
    if rootpath == 1
        fname_ICA  = ['z:\WANDER\data\ICA\s' num2str(isubject) '_epoched_MEG_ICA.mat'];
    else
        fname_ICA  = ['/shared/projects/project_wander/WANDER/data/ICA/s' num2str(isubject) '_epoched_MEG_ICA.mat'];
    end
end
...
if exist(fname_ICA,'file') && force ~= 1
    ...
    if restingstate == 1
        ...
        print(fig,'-painters','-dpdf','-r100',['z:\WANDER\images\ICA\s' num2str(isubject) '_corr_comp_EOGv_rs.pdf']);
        ...
        print(fig,'-painters','-dpdf','-r100',['z:\WANDER\images\ICA\s' num2str(isubject) '_topo_comp_EOGv_rs.pdf']);
        ...
        print(fig,'-painters','-dpdf','-r100',['z:\WANDER\images\ICA\s' num2str(isubject) '_corr_comp_ECG_rs.pdf']);
        ...
        cfg.comment = 'no';
        fig = figure; ft_topoplotIC(cfg,comp);
        print(fig,'-painters','-dpdf','-r100',['z:\WANDER\images\ICA\s' num2str(isubject) '_topo_comp_ECG_rs.pdf']);
        ...
        for ipart = 1 : 4
            ...
            for iteration = 1 : 5
                rejected_EOG = abs(EOGv_avg) > std(EOGv_avg(~rejected_EOG))*threshold;
            end
            ...
            title('average correlation component with vertical EOG');
            print(fig,'-painters','-dpdf','-r100',['z:\WANDER\images\ICA\s' num2str(isubject) '_corr_comp_EOGv_part ' num2str(ipart) '.pdf']);
            ...
            cfg.comment = 'no';
            fig = figure; ft_topoplotIC(cfg,comp);
            print(fig,'-painters','-dpdf','-r100',['z:\WANDER\images\ICA\s' num2str(isubject) '_topo_comp_EOGv_part ' num2str(ipart) '.pdf']);
            ...
            title('average correlation component with ECG');
            print(fig,'-painters','-dpdf','-r100',['z:\WANDER\images\ICA\s' num2str(isubject) '_corr_comp_ECG_part ' num2str(ipart) '.pdf']);
            ...
            cfg.comment = 'no';
            fig = figure; ft_topoplotIC(cfg,comp);
            print(fig,'-painters','-dpdf','-r100',['z:\WANDER\images\ICA\s' num2str(isubject) '_topo_comp_ECG_part ' num2str(ipart) '.pdf']);
