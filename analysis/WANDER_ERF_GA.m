...
for isubject = slist
    ...
    temp = load(['/shared/projects/project_wander/WANDER/data/ERF/s' num2str(isubject) '_' timing '.mat'],'ERF_cue','ERF_cue_high','ERF_cue_low');
...
% 
% 
% [Y I]                   = sort(temp.avg,'ascend');
% chan_neg_mag            = ft_channelselection(I(1), temp.label);
% chan_pos_mag            = ft_channelselection(I(end), temp.label);

% save('D:\analysis\WANDER\scripts\maxsensERF','chan_pos_cmb', 'chan_pos_mag', 'chan_neg_mag');
...
patch([ERF_cue_high_filt_sel_pos_GA_mag.time, ERF_cue_high_filt_sel_pos_GA_mag.time(end:-1:1)],[ERF_cue_high_filt_sel_pos_GA_mag.avg+ERF_cue_high_filt_sel_pos_GA_mag.std ./sqrt(22)*t, ERF_cue_high_filt_sel_pos_GA_mag.avg(end:-1:1)-ERF_cue_high_filt_sel_pos_GA_mag.std(end:-1:1) ./sqrt(21)*t],[0   0  0.8 ],'LineStyle','None');
vline2(time_max_mag,'k-');
...
% 
% %% plot overview with ERF pos, neg and topo FIRST COMPONENT
% 
% fig = figure; 
% subplot(3,2,1);
% cfg                     = [];
...
% cfg.xlim                = [time_max_mag time_max_mag];
% cfg.zlim                = 'maxabs';
% cfg.highlightchannel    = [chan_pos_mag; chan_neg_mag];
% cfg.highlight           = 'yes';
...
% cfg.xlim                = [time_max_cmb time_max_cmb];
% cfg.zlim                = 'maxabs';
% cfg.highlightchannel    = chan_pos_cmb;
% cfg.highlight           = 'yes';
% cfg.highlightsymbol     = 'pentagram';
% cfg.highlightcolor      = [0 0 0];
% cfg.highlightsize       = 16;
...
% t = 2.086;
% 
% patch([ERF_cue_low_filt_sel_pos_GA_mag.time, ERF_cue_low_filt_sel_pos_GA_mag.time(end:-1:1)],[ERF_cue_low_filt_sel_pos_GA_mag.avg+ERF_cue_low_filt_sel_pos_GA_mag.std ./sqrt(22)*1.725, ERF_cue_low_filt_sel_pos_GA_mag.avg(end:-1:1)-ERF_cue_low_filt_sel_pos_GA_mag.std(end:-1:1) ./sqrt(21)*2],[0 0.8 0 ],'FaceAlpha',.5,'LineStyle','None');
% axis tight;
% ax = axis;
% stim_times = [0:1/16:1.5];
% y1 = ones(size(stim_times))*ax(3);
...
% ax = axis;
% hold;
% patch([peak_latency, peak_latency(2:-1:1)],[ax(3),ax(3) ax(4),ax(4)],[0 0 0 ],'FaceAlpha',.2,'LineStyle','None');
% patch([ERF_cue_low_filt_sel_pos_GA_mag.time, ERF_cue_low_filt_sel_pos_GA_mag.time(end:-1:1)],[ERF_cue_low_filt_sel_pos_GA_mag.avg+ERF_cue_low_filt_sel_pos_GA_mag.std ./sqrt(22)*t, ERF_cue_low_filt_sel_pos_GA_mag.avg(end:-1:1)-ERF_cue_low_filt_sel_pos_GA_mag.std(end:-1:1) ./sqrt(21)*t],[0 0.8 0 ],'FaceAlpha',.5,'LineStyle','None');
% patch([ERF_cue_high_filt_sel_pos_GA_mag.time, ERF_cue_high_filt_sel_pos_GA_mag.time(end:-1:1)],[ERF_cue_high_filt_sel_pos_GA_mag.avg+ERF_cue_high_filt_sel_pos_GA_mag.std ./sqrt(22)*t, ERF_cue_high_filt_sel_pos_GA_mag.avg(end:-1:1)-ERF_cue_high_filt_sel_pos_GA_mag.std(end:-1:1) ./sqrt(21)*t],[1 0 0 ],'FaceAlpha',.5,'LineStyle','None');
% title('Positive channel');
% 
% subplot(3,2,5);
% patch([ERF_cue_low_filt_sel_neg_GA_mag.time, ERF_cue_low_filt_sel_neg_GA_mag.time(end:-1:1)],[ERF_cue_low_filt_sel_neg_GA_mag.avg+ERF_cue_low_filt_sel_neg_GA_mag.std ./sqrt(22)*t, ERF_cue_low_filt_sel_neg_GA_mag.avg(end:-1:1)-ERF_cue_low_filt_sel_neg_GA_mag.std(end:-1:1) ./sqrt(21)*t],[0 0.8 0 ],'FaceAlpha',.5,'LineStyle','None');
% axis tight;
% ax = axis;
% stim_times = [0:1/16:1.5];
% y1 = ones(size(stim_times))*ax(3);
...
% patch([peak_latency, peak_latency(2:-1:1)],[ax(3),ax(3) ax(4),ax(4)],[0 0 0 ],'FaceAlpha',.2,'LineStyle','None');
% patch([ERF_cue_low_filt_sel_neg_GA_mag.time, ERF_cue_low_filt_sel_neg_GA_mag.time(end:-1:1)],[ERF_cue_low_filt_sel_neg_GA_mag.avg+ERF_cue_low_filt_sel_neg_GA_mag.std ./sqrt(22)*t, ERF_cue_low_filt_sel_neg_GA_mag.avg(end:-1:1)-ERF_cue_low_filt_sel_neg_GA_mag.std(end:-1:1) ./sqrt(21)*t],[0 0.8 0 ],'FaceAlpha',.5,'LineStyle','None');
% patch([ERF_cue_high_filt_sel_neg_GA_mag.time, ERF_cue_high_filt_sel_neg_GA_mag.time(end:-1:1)],[ERF_cue_high_filt_sel_neg_GA_mag.avg+ERF_cue_high_filt_sel_neg_GA_mag.std ./sqrt(22)*t, ERF_cue_high_filt_sel_neg_GA_mag.avg(end:-1:1)-ERF_cue_high_filt_sel_neg_GA_mag.std(end:-1:1) ./sqrt(21)*t],[1 0 0 ],'FaceAlpha',.5,'LineStyle','None');
% title('Negative channel');
% 
% subplot(3,2,4);
% patch([ERF_cue_low_filt_sel_pos_GA_cmb.time, ERF_cue_low_filt_sel_pos_GA_cmb.time(end:-1:1)],[ERF_cue_low_filt_sel_pos_GA_cmb.avg+ERF_cue_low_filt_sel_pos_GA_cmb.std ./sqrt(22)*t, ERF_cue_low_filt_sel_pos_GA_cmb.avg(end:-1:1)-ERF_cue_low_filt_sel_pos_GA_cmb.std(end:-1:1) ./sqrt(21)*t],[0 0.8 0 ],'FaceAlpha',.5,'LineStyle','None');
% axis tight;
% ax = axis;
% stim_times = [0:1/16:1.5];
% y1 = ones(size(stim_times))*ax(3);
...
% patch([peak_latency, peak_latency(2:-1:1)],[ax(3),ax(3) ax(4),ax(4)],[0 0 0 ],'FaceAlpha',.2,'LineStyle','None');
% patch([ERF_cue_low_filt_sel_pos_GA_cmb.time,  ERF_cue_low_filt_sel_pos_GA_cmb.time(end:-1:1)], [ERF_cue_low_filt_sel_pos_GA_cmb.avg  + ERF_cue_low_filt_sel_pos_GA_cmb.std  ./sqrt(22)*t, ERF_cue_low_filt_sel_pos_GA_cmb.avg(end:-1:1)-ERF_cue_low_filt_sel_pos_GA_cmb.std(end:-1:1) ./sqrt(21)*t],[0 0.8 0 ],'FaceAlpha',.5,'LineStyle','None');
% patch([ERF_cue_high_filt_sel_pos_GA_cmb.time, ERF_cue_high_filt_sel_pos_GA_cmb.time(end:-1:1)],[ERF_cue_high_filt_sel_pos_GA_cmb.avg + ERF_cue_high_filt_sel_pos_GA_cmb.std ./sqrt(22)*t, ERF_cue_high_filt_sel_pos_GA_cmb.avg(end:-1:1)-ERF_cue_high_filt_sel_pos_GA_cmb.std(end:-1:1) ./sqrt(21)*t],[1 0 0 ],'FaceAlpha',.5,'LineStyle','None');
...
% set(fig,'PaperOrientation','landscape');
% set(fig,'Position',[50 50 1200 800]);
% print(fig,'-dpdf',['d:\analysis\WANDER\images\ERF_overview_' timing '.pdf']);
% print(fig,'-dpng',['d:\analysis\WANDER\images\ERF_overview_' timing '.png']);
...
% cfg.zlim                = 'maxabs';
% cfg.highlight           = 'on';
% cfg.highlightchannel    =  ft_channelselection(find(stat.mask), stat.label);
% cfg.highlightsymbol     = 'pentagram';
% cfg.highlighsize        = 13;
...
set(fig,'PaperOrientation','landscape');
set(fig,'Position',[50 50 1200 800]);
print(fig,'-dpdf',['d:\analysis\WANDER\images\ERF_overview_cue_second.pdf']);
print(fig,'-dpng',['d:\analysis\WANDER\images\ERF_overview_cue_second.png']);
...
Nsub                    = length(slist);
cfg                     = [];
cfg.latency             = [time_max_mag-0.02 time_max_mag+0.02];
cfg.avgovertime         = 'yes';
cfg.avgoverchan         = 'yes';
cfg.method              = 'montecarlo';
cfg.method              = 'analytic';
...
cfg.zlim                = 'maxabs';
cfg.highlightchannel    = [chan_pos_mag];
cfg.highlight           = 'yes';
cfg.highlightsymbol     = '.';
cfg.highlightcolor      = [0 0 0];
cfg.highlightsize       = 20;
...
% set(fig,'PaperOrientation','landscape');
% set(fig,'Position',[50 50 1200 800]);
saveas(fig,'w:\WANDER\images\FIG1c_offset_topo.eps','eps2c');
saveas(fig,'w:\WANDER\images\FIG1c_offset_topo.png','png');
% 
% 
% figure;
% cfg                     = [];
% cfg.layout              = 'neuromag306cmb';
% cfg.xlim                = [time_max_cmb-pad time_max_cmb+pad];
% cfg.zlim                = 'maxabs';
% cfg.highlightchannel    = chan_pos_cmb;
% cfg.highlight           = 'yes';
% cfg.highlightsymbol     = 'pentagram';
