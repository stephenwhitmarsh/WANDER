function [behav] = REVISION_behaviour(isubject,force,rootpath)

if rootpath == 1
    fname_behav = ['d:\analysis\WANDER\data\behaviour\s' num2str(isubject) '_behav.mat'];
else
    fname_behav = ['/network/lustre/iss01/charpier/analyses/stephen.whitmarsh/WANDER/data/behaviour/s' num2str(isubject) '_behav.mat'];
