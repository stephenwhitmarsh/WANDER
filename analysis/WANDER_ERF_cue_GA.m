function WANDER_ERF_cue_GA(force,timing,rootpath)
...
for isubject = slist
    ...
    temp = load(['/shared/projects/project_wander/WANDER/data/ERF/s' num2str(isubject) '_' timing '.mat'],'ERF_probe');
...
for isubject = slist
    fprintf('Loading subject %d \n',isubject);    
    temp = load(['/shared/projects/project_wander/WANDER/data/ERF/s' num2str(isubject) '_' timing '.mat'],'ERF_probe_high');
...
for isubject = slist
    fprintf('Loading subject %d \n',isubject);    
    temp = load(['/shared/projects/project_wander/WANDER/data/ERF/s' num2str(isubject) '_' timing '.mat'],'ERF_probe_low');
...
for isubject = slist  
    cfg = [];
    cfg.latency = [-1 1];
    ERF_probe_high_end{isubject} = ft_selectdata(cfg,ERF_probe_high{isubject});
    ERF_probe_low_end{isubject} = ft_selectdata(cfg,ERF_probe_low{isubject});
end

ERF_probe_high_end_GA = ft_timelockgrandaverage([],ERF_probe_high_end{slist});
ERF_probe_low_end_GA = ft_timelockgrandaverage([],ERF_probe_low_end{slist});
...
ft_topoplotER(cfg,ERF_probe_low_end_GA,ERF_probe_high_end_GA);
...
stat                    = ft_timelockstatistics(cfg,ERF_probe_low_end{slist},ERF_probe_high_end{slist});
