function [TFR] = WANDER_TFR_downsampled(isubject,force,timing,rootpath,restingstate)
...
if restingstate == 1
    if rootpath == 1
        fname_TFR = ['w:\WANDER\data\TFR\s' num2str(isubject) '_TFR_rs_downsampled.mat'];
    else
        fname_TFR = ['/shared/projects/project_wander/WANDER/data/TFR/s' num2str(isubject) '_TFR_rs_downsampled.mat'];
    end
else
    if rootpath == 1
        fname_TFR = ['w:\WANDER\data\TFR\s' num2str(isubject) '_TFR_' timing '_downsampled.mat'];
    else
        fname_TFR = ['/shared/projects/project_wander/WANDER/data/TFR/s' num2str(isubject) '_TFR_' timing '_downsampled.mat'];
    end
end
