function [data_MEG_stim_avg, data_MEG_stim_avg_high, data_MEG_stim_avg_low, data_MEG_stim_bin, data_MEG_stim_bin_high, data_MEG_stim_bin_low, data_MEG_stim_MI, data_MEG_stim_MI_high, data_MEG_stim_MI_low] = WANDER_timelock_SSEF_phase(isubject,rootpath,force)
          
if rootpath == 1
    fname_SSEF_phase = ['w:\WANDER\data\SSEF\SSEF_phase_' num2str(isubject) '_ratings.mat'];
else
    fname_SSEF_phase = ['/shared/projects/project_wander/WANDER/data/SSEF/SSEF_phase_' num2str(isubject) '_ratings.mat'];
end
