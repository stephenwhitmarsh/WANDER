function [data_EGG] = WANDER_filter_EGG(isubject,force,rootpath,restingstate)

[dataset_task, dataset_rs] = WANDER_subjectinfo;

if restingstate == 1
    if rootpath == 1
        fname_EGGfilt = ['W:\WANDER\data\EGG\s' num2str(isubject) '_EGG_rs.mat'];
    else
        fname_EGGfilt = ['/shared/projects/project_wander/WANDER/data/raw/s' num2str(isubject) '_EGG_rs.mat'];
    end
else
    if rootpath == 1
        fname_EGGfilt = ['W:\WANDER\data\EGG\s' num2str(isubject) '_EGG.mat'];
    else
        fname_EGGfilt = ['/shared/projects/project_wander/WANDER/data/raw/s' num2str(isubject) '_EGG.mat'];
    end
end
