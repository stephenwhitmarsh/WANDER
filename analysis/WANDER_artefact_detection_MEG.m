...
if restingstate == 1
    if rootpath == 1
        fname_artdef = ['w:\WANDER\data\artefacts\s' num2str(isubject) '_artdef_MEG_cuelocked_rs.mat'];
    else
        fname_artdef = ['/shared/projects/project_wander/WANDER/data/artefacts/s' num2str(isubject) '_artdef_MEG_cuelocked_rs.mat'];
    end
else
    if rootpath == 1
        fname_artdef = ['z:\WANDER\data\artefacts\s' num2str(isubject) '_artdef_MEG_cuelocked.mat'];
    else
