function ERF = WANDER_ERF_nomatching(isubject,force,timing,rootpath)
...
if rootpath == 1
    fname_ERF = ['W:\analysis\WANDER\data\ERF\s' num2str(isubject) '.mat'];
else
    fname_ERF = ['/home/swhitmarsh/WANDER/data/ERF/s' num2str(isubject) '.mat'];
end
